<h2 class="text-xl font-bold text-white mb-6 text-center">Registreren</h2>
...
<form method="POST" action="/register" class="space-y-5">
    ...
    <div>
        <label for="username" class="block text-sm text-gray-400 mb-1.5">Gebruikersnaam</label>
        <input type="text"
               id="username"
               name="username"
        ...
        <?php if (isset($errors['username'])): ?>
            <p class="text-red-400 text-sm mt-1.5"><?= e($errors['username'][0]) ?></p>
        <?php endif; ?>
    </div>
...
<p class="text-center text-sm text-gray-500 mt-6">
    Heb je al een account? <a href="/login" class="text-accent-400 hover:text-accent-300 transition-colors duration-200">Log dan hier in</a>
</p>